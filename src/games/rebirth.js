...
export function update() {
  if (!ticks) {
    ...
    diaWorld = 1;
    diaCount = 1;
    player = { pos: vec(110, 57), ox: 10, vel: vec(), world: 1, state: "run" };
    multiplier = 1;
  }
  color("black");
  rect(100, 60, 100, 40);
  ...
  remove(tracks, (t) => {
    ...
    char("a", t.x, 57, { mirror: { x: t.world > 0 ? -1 : 1 } });
  ...
  if (nextDiaTicks < 0) {
    ...
    dias.push({
      pos: vec(diaWorld > 0 ? 203 : -3, rnd() < 0.5 ? 57 : rnd(40, 50)),
